...
public class MostrarUsuarios extends javax.swing.JDialog {

    public static CollectorDao collectorDao;
    private int mousepX;
    private int mousepY;
    private static ArrayList<Usuario> usuarios = new ArrayList<>();
    private static String [] titulos = {"Username","Nombre", "Apellidos", "Tipo", "Email"};
    ...
    public void actualizarTabla(){
        try {
            ...
            for(Usuario usu : usuarios){
                ...
                String [] filas = {username, nombre, apellidos, tipo, email};
                dtm.addRow(filas);
            }
    ...
    private void initComponents() {
        ...
        LabelMostrar.setText("MOSTRAR USUARIOS");
